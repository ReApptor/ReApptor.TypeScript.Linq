...
namespace WeAre.ReApptor.Tools.CodeGenerator
{
    public class Program
    {
        ...
        {
            Console.WriteLine($"{Name}: neutralResourcePath=\"{settings.NeutralResourcePath}\", destinationPath=\"{settings.DestinationPath}\" type=\"{settings.Type}\", neutralLanguage=\"{settings.NeutralLanguage}\" include=\"{string.Join("; ", (settings.Include ?? new string[0]))}\" exclude=\"{string.Join("; ", (settings.Exclude ?? new string[0]))}\".");
        ...
        {
            // <Exec Command="dotnet run --project &quot;$(ProjectDir)../WeAre.Tools.CodeGenerator/WeAre.Tools.CodeGenerator.csproj&quot; &quot;$(ProjectDir)SharedResources.resx&quot; &quot;$(ProjectDir)../WeAre.Tools.WebUI.Resources/SharedResources.cs&quot; 1 fi" />
            // <Exec Command="dotnet run --project &quot;$(ProjectDir)../WeAre.Tools.CodeGenerator/WeAre.Tools.CodeGenerator.csproj&quot; &quot;$(ProjectDir)SharedResources.resx&quot; &quot;$(ProjectDir)../WeAre.Tools.WebUI/src/localization/Localizer.ts&quot; 0 fi" />
