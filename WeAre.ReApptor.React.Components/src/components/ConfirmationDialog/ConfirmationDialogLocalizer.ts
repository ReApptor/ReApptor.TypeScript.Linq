...
class ConfirmationDialogLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.closeButtonLanguageItemName, { language: `en`, value: `Close` }, { language: `uk`, value: `Закрити` }, { language: `sv`, value: `Stäng` }, { language: `ru`, value: `Отмена` }, { language: `pl`, value: `Zamknij` }, { language: `nb`, value: `Lukk` }, { language: `fi`, value: `Ei` }, { language: `da`, value: `Luk` },);
