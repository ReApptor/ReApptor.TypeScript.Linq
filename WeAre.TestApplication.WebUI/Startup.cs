...
using WeAre.TestApplication.WebUI.Server.Providers;
using WeAre.ReApptor.Common.Configuration;
using WeAre.ReApptor.Common.Filters;
using WeAre.ReApptor.Common.Helpers;
using WeAre.ReApptor.Common.Interfaces.ACM;
using WeAre.ReApptor.Common.Middlewares;
using WeAre.ReApptor.Common.Providers;
using WeAre.ReApptor.Services.ACM.Implementation;
using WeAre.TestApplication.Common;
using WeAre.TestApplication.WebUI.Server.Middlewares;
using WebEssentials.AspNetCore.Pwa;
using SameSiteMode = Microsoft.AspNetCore.Http.SameSiteMode;

namespace WeAre.TestApplication.WebUI
{
    public class Startup
    {
        ...
        {
            services.AddLocalization(options => options.ResourcesPath = "../WeAre.ReApptor.TemplateApp.WebUI.Resources/Resources");
