...
using WeAre.ReApptor.Services.Cache.Models;

namespace WeAre.TestApplication.Common.Configuration
{
    public sealed class TestApplicationConfiguration : BaseEnvironmentConfiguration<TestApplicationConfiguration>
    {
        ...
        public SymmetricSecurityKey TokenSecurityKey
        {
            get
            {
                ...
                {
                    string value = GetEnvironmentVariable("TOKEN_SECURITY_KEY", "123-456-789-abc-def-ghi");
