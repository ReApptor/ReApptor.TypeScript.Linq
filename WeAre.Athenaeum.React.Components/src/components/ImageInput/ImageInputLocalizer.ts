...
class ImageInputLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.moveToTopLanguageItemName, { language: `en`, value: `Move to top` }, { language: `uk`, value: `UK: Move to top` }, { language: `sv`, value: `Flytta upp` }, { language: `ru`, value: `RU: Move to top` }, { language: `pl`, value: `Podnieść` }, { language: `nb`, value: `Flytte opp` }, { language: `fi`, value: `Siirrä huipulle` }, { language: `da`, value: `Flytte op` },);
        this.set(this.moveUpLanguageItemName, { language: `en`, value: `Move up` }, { language: `uk`, value: `UK: Move up` }, { language: `sv`, value: `Flytta till toppen` }, { language: `ru`, value: `RU: Move up` }, { language: `pl`, value: `Przejdź do góry` }, { language: `nb`, value: `Flytt til toppen` }, { language: `fi`, value: `Siirrä ylös` }, { language: `da`, value: `Flyt til toppen` },);
        this.set(this.moveDownLanguageItemName, { language: `en`, value: `Move below` }, { language: `uk`, value: `UK: Move below` }, { language: `sv`, value: `Flytta ner` }, { language: `ru`, value: `RU: Move below` }, { language: `pl`, value: `Padnij` }, { language: `nb`, value: `Flytte ned` }, { language: `fi`, value: `Siirrä alas` }, { language: `da`, value: `Flyt ned` },);
    }
