...
class ImageInputLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.saveLanguageItemName, { language: `en`, value: `Save` }, { language: `uk`, value: `UK: Save` }, { language: `sv`, value: `Spara` }, { language: `ru`, value: `RU: Save` }, { language: `pl`, value: `PL: Save` }, { language: `nb`, value: `NB: Save` }, { language: `fi`, value: `Tallentaa` }, { language: `da`, value: `DA: Save` },);
