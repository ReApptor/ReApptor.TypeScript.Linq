...
class FileInputLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.chooseFileLanguageItemName, { language: `en`, value: `Choose file` }, { language: `uk`, value: `UK: Choose file` }, { language: `sv`, value: `Välj fil` }, { language: `ru`, value: `RU: Choose file` }, { language: `pl`, value: `PL: Choose file` }, { language: `nb`, value: `Choose file` }, { language: `fi`, value: `Valitse tiedosto` }, { language: `da`, value: `Choose file` },);
