...
class DropdownLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        //Initializer
        this.set(this.multipleSelectedLanguageItemName, { language: `en`, value: `{0} selected` }, { language: `uk-ua`, value: `UK-UA: {0} selected` }, { language: `sv`, value: `{0} valt` }, { language: `ru`, value: `{0} выбрано` }, { language: `pl`, value: `PL: {0} selected` }, { language: `fi`, value: `{0} valittu` },);
        this.set(this.noItemsLanguageItemName, { language: `en`, value: `No items found` }, { language: `uk-ua`, value: `UK-UA: No items found` }, { language: `sv`, value: `Inga objekt hittades` }, { language: `ru`, value: `Данные не найдены` }, { language: `pl`, value: `PL: No items found` }, { language: `fi`, value: `Kohteita ei löytynyt` },);
        this.set(this.noDataLanguageItemName, { language: `en`, value: `No data` }, { language: `uk-ua`, value: `UK-UA: No data` }, { language: `sv`, value: `Ingen information` }, { language: `ru`, value: `Нет данных` }, { language: `pl`, value: `PL: No data` }, { language: `fi`, value: `Ei tietoja` },);
        this.set(this.filterResultsLanguageItemName, { language: `en`, value: `Filter results` }, { language: `uk-ua`, value: `UK-UA: Filter results` }, { language: `sv`, value: `Filtrera resultat` }, { language: `ru`, value: `RU: Filter results` }, { language: `pl`, value: `PL: Filter results` }, { language: `fi`, value: `Suodata tulokset` },);
        ...
        this.set(this.addLanguageItemName, { language: `en`, value: `Add` }, { language: `uk-ua`, value: `UK-UA: Add` }, { language: `sv`, value: `SV: Add` }, { language: `ru`, value: `Новый` }, { language: `pl`, value: `PL: Add` }, { language: `fi`, value: `Lisää` },);
        this.set(this.nothingSelectedLanguageItemName, { language: `en`, value: `Nothing is selected` }, { language: `uk-ua`, value: `UK-UA: Nothing is selected` }, { language: `sv`, value: `Ingenting är valt` }, { language: `ru`, value: `RU: Nothing is selected` }, { language: `pl`, value: `PL: Nothing is selected` }, { language: `fi`, value: `Ei mitään valittu` },);
    }
