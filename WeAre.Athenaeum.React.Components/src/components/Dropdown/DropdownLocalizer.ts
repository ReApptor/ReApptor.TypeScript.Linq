...
class DropdownLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        //Initializer
        this.set(this.multipleSelectedLanguageItemName, { language: `en`, value: `{0} selected` }, { language: `uk`, value: `{0} вибран(о)` }, { language: `sv`, value: `{0} valt` }, { language: `ru`, value: `{0} выбран(о)` }, { language: `pl`, value: `PL: {0} selected` }, { language: `nb`, value: `NB: {0} selected` }, { language: `fi`, value: `{0} valittu` }, { language: `da`, value: `DA: {0} selected` },);
        ...
        this.set(this.noDataLanguageItemName, { language: `en`, value: `No data` }, { language: `uk`, value: `Немає даних` }, { language: `sv`, value: `Ingen information` }, { language: `ru`, value: `Нет данных` }, { language: `pl`, value: `PL: No data` }, { language: `nb`, value: `NB: No data` }, { language: `fi`, value: `Ei tietoja` }, { language: `da`, value: `DA: No data` },);
