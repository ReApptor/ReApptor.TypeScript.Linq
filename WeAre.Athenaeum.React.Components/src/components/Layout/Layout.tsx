...
import {ch, WebApplicationType, SwipeDirection, PageRouteProvider, IBasePage, ILayoutPage, ApplicationContext, IGlobalResize, IBaseAsyncComponentState, BaseAsyncComponent, IAsyncComponent, AlertModel} from "@weare/athenaeum-react-common";
...
export default class Layout extends BaseAsyncComponent<{}, ILayoutState, ApplicationContext> implements ILayoutPage, IGlobalResize {
    ...
    private get alertModel(): any {
        const model: any = new AlertModel();
        model.message = "Test 123";
        return model;
    }
