...
class DocumentPreviewModalLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.downloadLanguageItemName, { language: `en`, value: `Download` }, { language: `uk`, value: `Завантажити` }, { language: `sv`, value: `SV: Download` }, { language: `ru`, value: `Загрузить` }, { language: `pl`, value: `PL: Download` }, { language: `fi`, value: `FI: Download` },);
    }
