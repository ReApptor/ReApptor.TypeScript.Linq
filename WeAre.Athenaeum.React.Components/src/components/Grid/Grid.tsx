...
export default class Grid<TItem = {}> extends BaseAsyncComponent<IGridProps<TItem>, IGridState<TItem>,TGridData<TItem>> implements IGrid {
    ...
    private _language: string = Localizer.language;
    ...
    private async buildModelAsync(): Promise<void> {
        ...
        this._language = Localizer.language;
        this._grid = null;
        this._rows = null;
    ...
    public async componentWillReceiveProps(nextProps: IGridProps<TItem>): Promise<void> {
        ...
        const newLanguage: boolean = (this._language !== Localizer.language);
        ...
        return (
            <tr className={styles.emptyRow}>
                <td colSpan={this.colSpan}>
                    {Localizer.get(this.model.noDataText)}
                </td>
            </tr>
        );
    }
    ...
    
                            {
                                ...
                                (
                                    <Pagination className={styles.pagination}
                                                ...
                                                onChange={async (sender: any, pageNumber: number, pageSize: number) => await this.paginateAsync(pageNumber, pageSize)}
                                    />
                                )
                            }
