...
class BaseInputLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.validatorsLengthLanguageItemName, { language: `en`, value: `Text is too short` }, { language: `uk`, value: `UK: Text is too short` }, { language: `sv`, value: `Text för kort` }, { language: `ru`, value: `RU: Text is too short` }, { language: `pl`, value: `Tekst za krótki` }, { language: `nb`, value: `Teksten er for kort` }, { language: `fi`, value: `Teksti on liian lyhyt` }, { language: `da`, value: `Teksten er for kort` },);
        this.set(this.validatorsNumberRangeLanguageItemName, { language: `en`, value: `Value must be in range {0} - {1}` }, { language: `uk`, value: `UK: Value must be in range {0} - {1}` }, { language: `sv`, value: `Värde måste vara inom intervallet {0} - {1}` }, { language: `ru`, value: `RU: Value must be in range {0} - {1}` }, { language: `pl`, value: `Liczba musi się zawierać w przedziale {0} - {1}` }, { language: `nb`, value: `Verdien må være mellom {0} - {1}` }, { language: `fi`, value: `Arvon pitää olla väliltä {0} - {1}` }, { language: `da`, value: `Værdien skal være i området {0} - {1}` },);
        this.set(this.validatorsDocumentTypeNotSupportedLanguageItemName, { language: `en`, value: `Document type is not supported, choose file with extension {0}` }, { language: `uk`, value: `UK: Document type is not supported, choose file with extension {0}` }, { language: `sv`, value: `Dokumenttyp stöds inte. Välj dokument som är {0}.` }, { language: `ru`, value: `RU: Document type is not supported, choose file with extension {0}` }, { language: `pl`, value: `Format dokumentu nieprawidłowy. Wybierz dokument {0}` }, { language: `nb`, value: `Dokumenttype støttes ikke. Velg fil med filtypen {0}` }, { language: `fi`, value: `Dokumentin tyyppi ei ole tuettu. Valitse tiedosto, joka on {0}` }, { language: `da`, value: `Dokumenttype understøttes ikke. Vælg fil med udvidelse {0}` },);
        this.set(this.validatorsDocumentTooBigLanguageItemName, { language: `en`, value: `Document file is too big` }, { language: `uk`, value: `UK: Document file is too big` }, { language: `sv`, value: `Dokument filen är för stor` }, { language: `ru`, value: `RU: Document file is too big` }, { language: `pl`, value: `Dokument jest za duży` }, { language: `nb`, value: `Dokumentfilen er for stor` }, { language: `fi`, value: `Dokumentti-tiedoston koko on liian suuri` }, { language: `da`, value: `Dokumentfilen er for stor` },);
