        ...
        return (
            <div className={styles.signature} onTouchStart={(e: React.TouchEvent) => this.preventSwipe(e)}>
                ...
                <div className={styles.buttonContainer}>
                    <Button type={ButtonType.Orange} onClick={() => this.clearCanvas()} label={Localizer.componentSignatureWidgetClear} />
                    <Button type={ButtonType.Blue} onClick={() => this.saveSignature()} label={Localizer.componentSignatureWidgetDone} />
                </div>
            </div>
        );
    }
