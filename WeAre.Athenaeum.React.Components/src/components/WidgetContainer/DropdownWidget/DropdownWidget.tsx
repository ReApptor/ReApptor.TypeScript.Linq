        ...
        return (!this.props.noDescription)
            ? (this.selectedListItem != null)
                ? ((this.props.noSubtext) && (this.selectedListItem.subtext))
                    ? `${Localizer.get(this.selectedListItem.text.toUpperCase())}, ${Localizer.get(this.selectedListItem.subtext)}`
                    : Localizer.get(this.selectedListItem.text).toUpperCase()
                : (this.props.description)
                    ? Localizer.get(this.props.description)
                    : ""
            : "";
    }
