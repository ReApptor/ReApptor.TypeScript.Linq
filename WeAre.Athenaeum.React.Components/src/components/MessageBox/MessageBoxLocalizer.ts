...
class MessageBoxLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.yesLanguageItemName, { language: `en`, value: `Yes` }, { language: `uk`, value: `UK: Yes` }, { language: `sv`, value: `Ja` }, { language: `ru`, value: `Да` }, { language: `pl`, value: `Tak` }, { language: `nb`, value: `NB: Yes` }, { language: `fi`, value: `Kyllä` }, { language: `da`, value: `Ja` },);
        this.set(this.noLanguageItemName, { language: `en`, value: `No` }, { language: `uk`, value: `UK: No` }, { language: `sv`, value: `Nej` }, { language: `ru`, value: `Нет` }, { language: `pl`, value: `Nie` }, { language: `nb`, value: `NB: No` }, { language: `fi`, value: `Ei` }, { language: `da`, value: `Nej` },);
        this.set(this.abortLanguageItemName, { language: `en`, value: `Abort` }, { language: `uk`, value: `UK: Abort` }, { language: `sv`, value: `Avbryt` }, { language: `ru`, value: `Прервать` }, { language: `pl`, value: `Anulować` }, { language: `nb`, value: `NB: Abort` }, { language: `fi`, value: `Keskeytä` }, { language: `da`, value: `Afbryd` },);
        this.set(this.retryLanguageItemName, { language: `en`, value: `Retry` }, { language: `uk`, value: `UK: Retry` }, { language: `sv`, value: `Försök igen` }, { language: `ru`, value: `Повторить` }, { language: `pl`, value: `Spróbuj ponownie` }, { language: `nb`, value: `NB: Retry` }, { language: `fi`, value: `Yritä uudelleen` }, { language: `da`, value: `Prøv igen` },);
        this.set(this.ignoreLanguageItemName, { language: `en`, value: `Ignore` }, { language: `uk`, value: `UK: Ignore` }, { language: `sv`, value: `Ignorera` }, { language: `ru`, value: `Отклонить` }, { language: `pl`, value: `Ignoruj` }, { language: `nb`, value: `NB: Ignore` }, { language: `fi`, value: `Ohita` }, { language: `da`, value: `Ignorer` },);
        this.set(this.cancelLanguageItemName, { language: `en`, value: `Cancel` }, { language: `uk`, value: `UK: Cancel` }, { language: `sv`, value: `Avbryt` }, { language: `ru`, value: `Отмена` }, { language: `pl`, value: `Anuluj` }, { language: `nb`, value: `NB: Cancel` }, { language: `fi`, value: `Peruuta` }, { language: `da`, value: `Annuller` },);
    }
