...
export default class Modal<TData = {}> extends BaseAsyncComponent<IModalProps<TData>, IModalState> {
    ...
    private async setModal(isOpen: boolean): Promise<void> {
    ...
    public async toggleAsync(data: TData | null = null): Promise<void> {
        if (this.state.isOpen) {
            await this.closeAsync();
        } else {
            await this.openAsync(data);
        }
    }
    
    public async openAsync(data: TData | null = null): Promise<void> {
    ...
    private get title(): string {
        return this.props.title || "Modal dialog";
    }
