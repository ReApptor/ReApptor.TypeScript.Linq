...
export default class NavigationWidget extends BaseComponent<INavigationWidgetProps, INavigationWidgetState> implements IBaseWidget {
    ...
    protected get prevLabel(): string {
        return this.props.prevLabel || Localizer.componentNavigationWidgetPrevious;
    }

    protected get prevDescription(): string {
        return this.props.prevDescription || Localizer.componentNavigationWidgetReturnToPrevious;
    }

    protected get label(): string {
        return this.props.label || Localizer.componentNavigationWidgetNext;
    }

    protected get description(): string {
        return this.props.description || Localizer.componentNavigationWidgetGoToNext;
    }
