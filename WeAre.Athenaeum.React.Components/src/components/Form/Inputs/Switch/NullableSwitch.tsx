...
import NullableCheckbox, { INullableCheckboxProps } from "@/components/Form/Inputs/Checkbox/NullableCheckbox";
...
export default class NullableSwitch extends NullableCheckbox<INullableSwitchProps> {
