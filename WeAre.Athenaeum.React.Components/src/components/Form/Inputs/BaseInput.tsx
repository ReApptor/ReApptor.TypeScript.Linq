...
import {BaseComponent, IBaseComponent, IGlobalClick} from "@weare/athenaeum-react-common";
...
export interface IBaseInputProps<TInputValue extends BaseInputValue> {
    ...
    className?: string;
    prepend?: string | React.ReactNode | boolean;
    append?: string | React.ReactNode | boolean;
    hidden?: boolean;
    clickToEdit?: boolean;
    format?: TFormat;
    inline?: boolean;
...
export default abstract class BaseInput<TInputValue extends BaseInputValue, TProps extends IBaseInputProps<TInputValue>, TState extends IBaseInputState<TInputValue>>
    ...
    protected async valueChangeHandlerAsync(event: React.FormEvent<HTMLInputElement> | React.FormEvent<HTMLTextAreaElement>): Promise<void> {
        ...
        let str: string = event.currentTarget.value;
    ...
    public renderPrepend(): React.ReactNode {
        return (
            <div className="input-group-prepend">
                <span className={this.css("input-group-text", styles.prepend)}>{this.props.prepend}</span>
            </div>
        );
    }
    ...
    public renderAppend(): React.ReactNode {
        return (
            <div className="input-group-append">
                <span className={this.css("input-group-text", styles.append)}>{this.props.append}</span>
            </div>
        );
    }
