...
class ConfirmationDialogLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.confirmButtonLanguageItemName, { language: `en`, value: `Confirm` }, { language: `sv`, value: `Bekräfta` }, { language: `ru`, value: `RU: Confirm` }, { language: `pl`, value: `PL: Confirm` }, { language: `fi`, value: `Kyllä` },);
        this.set(this.closeButtonLanguageItemName, { language: `en`, value: `Close` }, { language: `sv`, value: `SV: Close` }, { language: `ru`, value: `RU: Close` }, { language: `pl`, value: `PL: Close` }, { language: `fi`, value: `Ei` },);
        this.set(this.commentLanguageItemName, { language: `en`, value: `Please leave a comment` }, { language: `sv`, value: `Var vänlig och lämna en kommentar` }, { language: `ru`, value: `RU: Please leave a comment` }, { language: `pl`, value: `PL: Please leave a comment` }, { language: `fi`, value: `Ole hyvä ja kommentoi` },);
    }
