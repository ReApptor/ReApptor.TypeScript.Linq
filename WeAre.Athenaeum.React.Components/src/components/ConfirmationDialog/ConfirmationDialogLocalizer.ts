...
class ConfirmationDialogLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        this.set(this.confirmButtonLanguageItemName, { language: `en`, value: `Confirm` }, { language: `uk`, value: `Підтвердети` }, { language: `sv`, value: `Bekräfta` }, { language: `ru`, value: `Подтвердить` }, { language: `pl`, value: `Potwierdź` }, { language: `nb`, value: `Bekreft` }, { language: `fi`, value: `Kyllä` }, { language: `da`, value: `Bekræft` },);
        this.set(this.closeButtonLanguageItemName, { language: `en`, value: `Close` }, { language: `uk`, value: `Закрити` }, { language: `sv`, value: `Stäng` }, { language: `ru`, value: `Отмена` }, { language: `pl`, value: `Zamknij` }, { language: `nb`, value: `Stäng` }, { language: `fi`, value: `Ei` }, { language: `da`, value: `Luk` },);
