...
class NavigationWidgetLocalizer extends BaseComponentLocalizer {
    ...
    constructor() {
        ...
        //Initializer
        this.set(this.previousLanguageItemName, { language: `en`, value: `Previous` }, { language: `uk`, value: `Назад` }, { language: `sv`, value: `Föregående` }, { language: `ru`, value: `RU: Previous` }, { language: `pl`, value: `PL: Previous` }, { language: `fi`, value: `Edellinen` },);
        ...
        this.set(this.nextLanguageItemName, { language: `en`, value: `Next` }, { language: `uk`, value: `Далі` }, { language: `sv`, value: `Nästa` }, { language: `ru`, value: `RU: Next` }, { language: `pl`, value: `PL: Next` }, { language: `fi`, value: `Seuraava` },);
        this.set(this.goToNextLanguageItemName, { language: `en`, value: `Go to next step` }, { language: `uk`, value: `Перейти до наступного кроку` }, { language: `sv`, value: `Gå till nästa steg` }, { language: `ru`, value: `RU: Go to next step` }, { language: `pl`, value: `PL: Go to next step` }, { language: `fi`, value: `Siirry seuraavaan vaiheeseen` },);
    }
