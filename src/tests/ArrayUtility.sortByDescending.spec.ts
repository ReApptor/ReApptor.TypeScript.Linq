...
describe("sortByDescending", () => {
    ...
    test("should sort the array in ascending order by the first key", () => {
        people.sortByDescending(person => person.name, person => person.age);
    ...
    test("should sort the array in ascending order by the second key", () => {
        people.sortByDescending(null, person => person.name);
    ...
    test("should sort the array in descending order by the first key", () => {
        people.sortByDescending(person => person.name, person => person.age, person => person.age);
    ...
    test("date", () => {
        ...
        expect(items).toEqual([date6, date5, date4, date3, date2, date1, date0]);
    });
    ...
    test("date-as-string-and-string-to-date-cast-disabled", () => {
        ...
        expect(items).toEqual([date6, date5, date4, date3, date2, date0, date1]);
    });
